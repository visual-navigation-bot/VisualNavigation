...
def JoinPath(part1, part2):
    return _pywrap_tensorflow.JoinPath(part1, part2)
...
class FileStatistics(_object):
    ...
    if _newclass:
        mode = _swig_property(_pywrap_tensorflow.FileStatistics_mode_get, _pywrap_tensorflow.FileStatistics_mode_set)
